...
public interface ReportManager {
	...
	/**
	 * @deprecated shift to using constructReportDesigns instead, so that report definitions can be
	 *             persisted
	...
	/**
	 * This method provides a mechanism to validate input parameters, transform input parameters, or
	 * provide any other custom logic needed to set up the appropriate EvaluationContext that should
