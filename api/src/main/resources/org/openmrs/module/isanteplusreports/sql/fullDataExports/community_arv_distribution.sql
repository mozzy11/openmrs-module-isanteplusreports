...
FROM isanteplus.patient_dispensing pdisp,(select patient_id,max(dispensation_date) as dispensation_date from isanteplus.patient_dispensing where voided <> 1 AND dispensation_date BETWEEN :startDate AND :endDate group by 1)B
