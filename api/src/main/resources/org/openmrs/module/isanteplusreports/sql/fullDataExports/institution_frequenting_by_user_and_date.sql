select distinct usr.username as User, DATE(enc.encounter_datetime) as visitDate,
 COUNT(CASE WHEN (entype.uuid='17536ba6-dd7c-4f58-8014-08c7cb798ac7'
                           OR entype.uuid='349ae0b4-65c1-4122-aa06-480f186c8350'
                           ) 
						THEN enc.creator else null END) AS 'Nouveau Patient VIH',
 ...
 COUNT(CASE WHEN (entype.uuid='5c312603-25c1-4dbe-be18-1a167eb85f97'
						...
						THEN enc.creator else null END) AS 'Nouveau Patient Non VIH',
 COUNT(CASE WHEN (entype.uuid='17536ba6-dd7c-4f58-8014-08c7cb798ac7'
                           OR entype.uuid='349ae0b4-65c1-4122-aa06-480f186c8350'
...
COUNT(CASE WHEN (entype.uuid='49592bec-dd22-4b6c-a97f-4dd2af6f2171'
						...
						THEN enc.creator else null END) AS 'Patient Non VIH',
COUNT(CASE WHEN (entype.uuid='204ad066-c5c2-4229-9a62-644bc5617ca2'
                           OR entype.uuid='33491314-c352-42d0-bd5d-a9d0bffc9bf1'
						...
						THEN enc.creator else null END) AS 'Total Patient'
 FROM
 openmrs.users usr, openmrs.encounter enc, openmrs.encounter_type entype
 WHERE
 usr.user_id=enc.creator
 AND
