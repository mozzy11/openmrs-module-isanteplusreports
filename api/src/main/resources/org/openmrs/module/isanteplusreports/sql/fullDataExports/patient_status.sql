select pat.st_id as 'NO. de patient attribué par le site', pat.national_id as 'Numéro d\'identité national',
...
WHERE patstatus.start_date BETWEEN :startDate AND :endDate
