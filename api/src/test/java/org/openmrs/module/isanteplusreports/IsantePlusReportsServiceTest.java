...
import org.openmrs.module.isanteplusreports.api.impl.IsantePlusReportsServiceImpl;
import static org.mockito.Mockito.*;
import static org.hamcrest.Matchers.*;
import static org.junit.Assert.*;

/**
 * This is a unit test, which verifies logic in IsantePlusReportsService. It doesn't extend
 * BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring context.
 */
public class IsantePlusReportsServiceTest {
	
	@InjectMocks
	IsantePlusReportsServiceImpl basicModuleService;
