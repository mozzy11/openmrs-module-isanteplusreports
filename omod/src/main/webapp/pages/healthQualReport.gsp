...
<div>
    ...
    <div class="running-reports" class="clearfix">
        ...
        <form id="nonCodedForm" method="post">
            <fieldset id="run-report" style="float:right">
                <legend>
            ...
            <table id="indicators">
                ...
                <tbody>
                    <tr>
                        <th style="text-align: center; background-color: rgba(253, 245, 154, 0.38);" colspan="3"><i>Adult Indicators</i></th>
                    </tr>
                    <tr>
                    ...
                    <td style="text-align: center;">
                        <div>
                            ...
                            <select style="display:inline-block;margin: 0; min-width:80px; width:120px">
